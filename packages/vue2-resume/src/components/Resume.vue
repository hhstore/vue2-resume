        ...
        <tr>
          ...
          <td>
            <h5>
              ...
              <a
                target="_blank"
                v-bind:href="'https://' + cv.profile.website.github"
              >
          ...
          <td>
            <h5>
              ...
              <a
                target="_blank"
                v-bind:href="'http://' + cv.profile.website.blog"
              >
        ...
        <tr>
          ...
          <td>
            <h4>
              ...
              <a
                target="_blank"
                v-bind:href="'https://' + cv.profile.website.zhihu"
              >
          ...
          <td>
            <h4>
              ...
              <a
                target="_blank"
                v-bind:href="'https://' + cv.profile.website.douban"
              >
    ...
    <table class="ui table teal cv-table">
      ...
      <tbody>
        ...
        <tr v-for="item in cv.edu">
          ...
          <td>
            <h4>{{ item.edu_level }}</h4>
          </td>
          <td>
            <h4>{{ item.cet_level }}</h4>
          </td>
        </tr>
      </tbody>
    </table>
          ...
          <tr v-for="item in cv.etc">
            <td>
              ...
              <div v-for="v in item.desc">
                <!--详情-->
                <h5 class="cv-fix-content-tab8">
                  <i class="pointing right purple icon"></i>{{ v }}
                </h5>
              </div>
            </td>
          </tr>
...
export default {
  ...
  created() {
    ...
    console.log("开发模式:", process.env.VUE_APP_DEBUG);
  },
    ...
    return {
      ...
      cv:
        process.env.VUE_APP_DEBUG === "true"
          ? require("../assets/cv.tpl.json")
          : require("../assets/cv.prod.json"),
    };
  },
