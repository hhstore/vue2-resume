  ...
  <div class="cv-main">
    ...
    <table class="ui table teal cv-tb-job">
      ...
      <tr>
        ...
        <!--项目官网-->
        <td><h4><a target="_blank" v-bind:href="item.url"><i class="internet explorer icon teal"></i>项目官网</a></h4>
        </td>
        <!--项目周期-->
    ...
    <table class="ui table teal cv-tb-job">
      ...
      <tr v-for="item in cv.project.personal">
        <!--项目访问地址-->
        <td>
          <h4><i class="github icon teal"></i><a target="_blank" v-bind:href="'https://'+item.url">{{
              item.url
            }}</a>
          </h4>
        </td>
